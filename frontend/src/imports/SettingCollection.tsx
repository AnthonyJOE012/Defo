import svgPaths from "./svg-4dnqr9839o";
...
function Frame9() {
  return (
    <div className="absolute h-[22px] left-[25px] top-[276px] w-[106px]">
      <p className="absolute font-['Helvetica:Regular',sans-serif] leading-[22px] left-0 not-italic text-[16px] text-white top-0 whitespace-nowrap">My Library</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="absolute h-[22px] left-[25px] top-[527px] w-[103px]">
...
function Frame4() {
  return (
    <div className="absolute h-[874px] left-[99px] top-0 w-[303px]">
      ...
      <Frame7 />
      <Frame9 />
      <p className="absolute font-['Helvetica:Regular',sans-serif] leading-[22px] left-[25px] not-italic text-[16px] text-white top-[312px] whitespace-nowrap">Custom Bookmarks</p>
      <p className="absolute font-['Helvetica:Regular',sans-serif] leading-[22px] left-[25px] not-italic text-[16px] text-white top-[348px] whitespace-nowrap">Custom Bookmarks</p>
      <p className="absolute font-['Helvetica:Regular',sans-serif] leading-[22px] left-[25px] not-italic text-[16px] text-white top-[384px] whitespace-nowrap">Custom Bookmarks</p>
      <p className="absolute font-['Helvetica:Regular',sans-serif] leading-[22px] left-[25px] not-italic text-[16px] text-white top-[420px] whitespace-nowrap">Custom Bookmarks</p>
      <Frame6 />
      <Frame8 />
    </div>
  );
...
export default function SettingCollection() {
  return (
    <div className="bg-white relative size-full" data-name="Setting-Collection">
      ...
      <div className="absolute inset-[10.49%_41.4%_87.72%_54.73%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.584 15.584">
          <path d={svgPaths.p11a2af00} fill="var(--fill-0, #333333)" id="Vector" />
        </svg>
      </div>
