import svgPaths from "./svg-60podcrfbk";
...
function HamburgerButton({ className }: { className?: string }) {
  return (
    <div className={className || "absolute left-[351px] size-[38px] top-[77px]"} data-name="Hamburger-button (汉堡图标)">
...
function Frame1() {
  return (
    <div className="absolute h-[302px] left-[17px] top-[155px] w-[367px]">
...
function Frame2() {
  return (
    <div className="absolute h-[302px] left-[17px] top-[483px] w-[367px]">
...
function Frame3() {
  return (
    <div className="absolute h-[302px] left-[18px] top-[811px] w-[367px]">
    ...
    <div className="bg-white relative size-full" data-name="Home">
      ...
      <div className="absolute inset-[10.49%_41.4%_87.72%_54.73%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.584 15.584">
          <path d={svgPaths.p26f2e600} fill="var(--fill-0, #333333)" id="Vector" />
        </svg>
      </div>
