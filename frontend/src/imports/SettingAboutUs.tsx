import svgPaths from "./svg-94dqae3wkn";
...
function Frame6() {
  return (
    <div className="absolute h-[138px] left-[25px] text-white top-[276px] w-[235px]">
      <p className="absolute font-['Helvetica:Regular',sans-serif] leading-[22px] left-0 not-italic text-[24px] top-0 whitespace-nowrap">About US</p>
      <p className="absolute font-['Helvetica:Regular',sans-serif] leading-[22px] left-0 not-italic text-[16px] top-[100px] whitespace-nowrap">{`Design by Anthony `}</p>
      <div className="absolute font-['Helvetica:Regular','Noto_Sans_JP:Regular','Noto_Sans_SC:Regular',sans-serif] h-[66px] leading-[0] left-0 text-[15px] top-[31px] w-[235px]" style={{ fontVariationSettings: "'wght' 400" }}>
        <p className="leading-[22px] mb-0">感谢使用。</p>
        <p className="leading-[22px]">不介意的话给我打点钱，介意的话也要打。</p>
      </div>
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="absolute h-[874px] left-[99px] top-0 w-[303px]">
      ...
      <p className="absolute font-['Helvetica:Regular',sans-serif] leading-[22px] left-[25px] not-italic text-[24px] text-white top-[234px] whitespace-nowrap">Collection</p>
      <Frame6 />
      <p className="absolute font-['Helvetica:Regular','Noto_Sans_JP:Regular',sans-serif] leading-[22px] left-[25px] text-[24px] text-white top-[192px] whitespace-nowrap" style={{ fontVariationSettings: "'wght' 400" }}>{`Eng / 中 `}</p>
    </div>
  );
}
...
export default function SettingAboutUs() {
  return (
    <div className="bg-white relative size-full" data-name="Setting-About US">
      ...
      <div className="absolute inset-[10.49%_41.4%_87.72%_54.73%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.584 15.584">
          <path d={svgPaths.p367d9500} fill="var(--fill-0, #333333)" id="Vector" />
        </svg>
      </div>
