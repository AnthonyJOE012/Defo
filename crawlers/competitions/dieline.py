...
class DielineCrawler(BaseCrawler):
    """Crawler for Dieline (https://thedieline.com)."""

    BASE_URL = "https://thedieline.com"

    def __init__(self):
        super().__init__("Dieline", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from Dieline."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.dieline-project")
