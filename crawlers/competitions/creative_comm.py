"""Creative Communications competition crawler."""
...
class CreativeCommCrawler(BaseCrawler):
    """Crawler for Creative Communications (https://www.creativecommunications.com)."""

    BASE_URL = "https://www.creativecommunications.com"

    def __init__(self):
        super().__init__("Creative Communications", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from Creative Communications."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.cc-project")
