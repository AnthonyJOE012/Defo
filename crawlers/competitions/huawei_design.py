"""Huawei Design competition crawler."""
...
class HuaweiDesignCrawler(BaseCrawler):
    """Crawler for Huawei Design (https://huawei.com/design)."""

    BASE_URL = "https://huawei.com/design"

    def __init__(self):
        super().__init__("Huawei Design", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from Huawei Design."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.huawei-project")
