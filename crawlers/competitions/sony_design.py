"""Sony Design competition crawler."""
...
class SonyDesignCrawler(BaseCrawler):
    """Crawler for Sony Design (https://sony.com/design)."""

    BASE_URL = "https://sony.com/design"

    def __init__(self):
        super().__init__("Sony Design", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from Sony Design."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.sony-project")
