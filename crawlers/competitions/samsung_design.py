"""Samsung Design competition crawler."""
...
class SamsungDesignCrawler(BaseCrawler):
    """Crawler for Samsung Design (https://samsung.com/design)."""

    BASE_URL = "https://samsung.com/design"

    def __init__(self):
        super().__init__("Samsung Design", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from Samsung Design."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.samsung-project")
