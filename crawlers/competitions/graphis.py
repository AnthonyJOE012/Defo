...
class GraphisCrawler(BaseCrawler):
    """Crawler for Graphis (https://graphis.com)."""

    BASE_URL = "https://graphis.com"

    def __init__(self):
        super().__init__("Graphis", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from Graphis."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.graphis-project")
