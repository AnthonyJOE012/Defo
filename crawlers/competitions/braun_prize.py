"""Braun Prize competition crawler."""
...
class BraunPrizeCrawler(BaseCrawler):
    """Crawler for Braun Prize (https://www.braunprize.com)."""

    BASE_URL = "https://www.braunprize.com"

    def __init__(self):
        super().__init__("Braun Prize", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from Braun Prize."""
        articles = []
        headers = {
