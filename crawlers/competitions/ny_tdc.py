"""New York Type Directors Club competition crawler."""
...
class NyTdcCrawler(BaseCrawler):
    """Crawler for NY TDC (https://newworkoundation.org)."""

    BASE_URL = "https://newworkoundation.org"

    def __init__(self):
        super().__init__("NY Type Directors Club", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from NY TDC."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.nytdc-project")
