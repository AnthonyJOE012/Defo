"""H&M Design competition crawler."""
...
class HmDesignCrawler(BaseCrawler):
    """Crawler for H&M Design (https://hm.com/design)."""

    BASE_URL = "https://hm.com/design"

    def __init__(self):
        super().__init__("H&M Design", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from H&M Design."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.hm-project")
