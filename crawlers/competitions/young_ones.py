"""Young Ones competition crawler."""
...
class YoungOnesCrawler(BaseCrawler):
    """Crawler for Young Ones (https://youngones.com)."""

    BASE_URL = "https://youngones.com"

    def __init__(self):
        super().__init__("Young Ones", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from Young Ones."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.young-ones-project")
