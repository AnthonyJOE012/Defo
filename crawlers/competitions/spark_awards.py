"""Spark Design Awards competition crawler."""
...
class SparkAwardsCrawler(BaseCrawler):
    """Crawler for Spark Design Awards (https://www.sparkdesignawards.com)."""

    BASE_URL = "https://www.sparkdesignawards.com"

    def __init__(self):
        super().__init__("Spark Design Awards", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from Spark Design Awards."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.spark-project")
