"""Lexus Design Award competition crawler."""
...
class LexusDesignCrawler(BaseCrawler):
    """Crawler for Lexus Design Award (https://designawards.lexus.com)."""

    BASE_URL = "https://designawards.lexus.com"

    def __init__(self):
        super().__init__("Lexus Design Award", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from Lexus Design Award."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.lexus-project")
