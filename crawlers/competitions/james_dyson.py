"""James Dyson Award competition crawler."""
...
class JamesDysonCrawler(BaseCrawler):
    """Crawler for James Dyson Award (https://jamesdysonaward.org)."""

    BASE_URL = "https://jamesdysonaward.org"

    def __init__(self):
        super().__init__("James Dyson Award", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from James Dyson Award."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.winner-item")
