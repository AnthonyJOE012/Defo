...
class BrandNewCrawler(BaseCrawler):
    """Crawler for Brand New (https://brandnewawards.com)."""

    BASE_URL = "https://brandnewawards.com"

    def __init__(self):
        super().__init__("Brand New", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from Brand New."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.brandnew-project")
