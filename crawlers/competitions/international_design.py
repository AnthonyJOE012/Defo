"""International Design Awards competition crawler."""
...
class InternationalDesignCrawler(BaseCrawler):
    """Crawler for International Design Awards (https://www.idaste.org)."""

    BASE_URL = "https://www.idaste.org"

    def __init__(self):
        super().__init__("International Design Awards", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from International Design Awards."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.int-design-project")
