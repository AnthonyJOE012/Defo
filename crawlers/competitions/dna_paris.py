"""DNA Paris Design Awards competition crawler."""
...
class DnaParisCrawler(BaseCrawler):
    """Crawler for DNA Paris Design Awards (https://www.dnaparis.com)."""

    BASE_URL = "https://www.dnaparis.com"

    def __init__(self):
        super().__init__("DNA Paris Design Awards", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from DNA Paris Design Awards."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.dna-project")
