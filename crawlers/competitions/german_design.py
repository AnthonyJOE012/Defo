"""German Design Award competition crawler."""
...
class GermanDesignCrawler(BaseCrawler):
    """Crawler for German Design Award (https://www.german-design-award.com)."""

    BASE_URL = "https://www.german-design-award.com"

    def __init__(self):
        super().__init__("German Design Award", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from German Design Award."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.german-project")
