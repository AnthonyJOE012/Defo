"""Electrolux Design competition crawler."""
...
class ElectroluxCrawler(BaseCrawler):
    """Crawler for Electrolux Design (https://electrolux.com/design)."""

    BASE_URL = "https://electrolux.com/design"

    def __init__(self):
        super().__init__("Electrolux Design", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from Electrolux Design."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.electrolux-project")
