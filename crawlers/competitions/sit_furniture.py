"""SIT Furniture Design Award competition crawler."""
...
class SitFurnitureCrawler(BaseCrawler):
    """Crawler for SIT Furniture Design Award (https://sit-furniture-designaward.com)."""

    BASE_URL = "https://sit-furniture-designaward.com"

    def __init__(self):
        super().__init__("SIT Furniture Design Award", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from SIT Furniture Design Award."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.sit-project")
