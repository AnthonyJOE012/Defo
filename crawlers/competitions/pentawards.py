"""Pentawards competition crawler."""
...
class PentawardsCrawler(BaseCrawler):
    """Crawler for Pentawards (https://pentawards.com)."""

    BASE_URL = "https://pentawards.com"

    def __init__(self):
        super().__init__("Pentawards", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from Pentawards."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.penta-project")
