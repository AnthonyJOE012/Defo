"""Founder Type (方正字体) design competition crawler."""
...
class FounderTypeCrawler(BaseCrawler):
    """Crawler for Founder Type design competition (https://www.foundertype.com)."""

    BASE_URL = "https://www.foundertype.com"

    def __init__(self):
        super().__init__("Founder Type", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from Founder Type."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.founder-project")
