"""Transform Awards competition crawler."""
...
class TransformAwardsCrawler(BaseCrawler):
    """Crawler for Transform Awards (https://transformawards.com)."""

    BASE_URL = "https://transformawards.com"

    def __init__(self):
        super().__init__("Transform Awards", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from Transform Awards."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.transform-project")
