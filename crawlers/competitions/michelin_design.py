"""Michelin Design competition crawler."""
...
class MichelinDesignCrawler(BaseCrawler):
    """Crawler for Michelin Design (https://michelin.com/design)."""

    BASE_URL = "https://michelin.com/design"

    def __init__(self):
        super().__init__("Michelin Design", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from Michelin Design."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.michelin-project")
