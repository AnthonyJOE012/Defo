"""IF Student Award competition crawler."""
...
class IfStudentCrawler(BaseCrawler):
    """Crawler for IF Student Award (https://ifworlddesignguide.com/student)."""

    BASE_URL = "https://ifworlddesignguide.com/student"

    def __init__(self):
        super().__init__("IF Student Award", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from IF Student Award."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.student-project")
