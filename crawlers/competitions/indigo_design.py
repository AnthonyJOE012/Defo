"""Indigo Design Award competition crawler."""
...
class IndigoDesignCrawler(BaseCrawler):
    """Crawler for Indigo Design Award (https://indigodesignaward.com)."""

    BASE_URL = "https://indigodesignaward.com"

    def __init__(self):
        super().__init__("Indigo Design Award", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from Indigo Design Award."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.indigo-project")
