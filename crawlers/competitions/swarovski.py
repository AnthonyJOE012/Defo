"""Swarovski Design competition crawler."""
...
class SwarovskiCrawler(BaseCrawler):
    """Crawler for Swarovski Design (https://swarovski.com/design)."""

    BASE_URL = "https://swarovski.com/design"

    def __init__(self):
        super().__init__("Swarovski Design", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from Swarovski Design."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.swarovski-project")
