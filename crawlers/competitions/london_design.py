"""London Design Awards competition crawler."""
...
class LondonDesignCrawler(BaseCrawler):
    """Crawler for London Design Awards (https://www.londondesignawards.com)."""

    BASE_URL = "https://www.londondesignawards.com"

    def __init__(self):
        super().__init__("London Design Awards", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from London Design Awards."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.london-project")
