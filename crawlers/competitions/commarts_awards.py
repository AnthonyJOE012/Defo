"""Communication Arts Awards competition crawler."""
...
class CommartsAwardsCrawler(BaseCrawler):
    """Crawler for Communication Arts Awards (https://www.commarts.com)."""

    BASE_URL = "https://www.commarts.com"

    def __init__(self):
        super().__init__("Communication Arts Awards", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from Communication Arts Awards."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.commarts-project")
