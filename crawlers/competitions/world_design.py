"""World Design Awards competition crawler."""
...
class WorldDesignCrawler(BaseCrawler):
    """Crawler for World Design Awards (https://worlddesignawards.com)."""

    BASE_URL = "https://worlddesignawards.com"

    def __init__(self):
        super().__init__("World Design Awards", SourceType.COMPETITION)

    async def fetch_articles(self, **kwargs) -> list[Article]:
        """Fetch competition listings from World Design Awards."""
        articles = []
        headers = {
        ...
        async with httpx.AsyncClient(timeout=30.0, headers=headers) as client:
            try:
                ...
                entries = soup.select("div.project-item, article.entry, div.world-project")
